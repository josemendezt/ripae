import { CheckIcon, PanelTopCloseIcon, PauseIcon } from "lucide-react";
      ...
      <ul>
        ...
        <li className="flex justify-between items-center py-2 border-b">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <p className="font-medium">Successful monthly payment</p>
              <p className="text-sm text-gray-500">05 Feb 2024 at 3:10PM</p>
            </div>
          </div>
          <span>475$</span>
        </li>
        <li className="flex justify-between items-center py-2">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">05 Feb 2024 at 3:06PM</p>
            </div>
          </div>
          <span>475$</span>
        </li>
